...
<div class="container">
    ...
    <form class="form row" method="POST" action="" name="myForm" onsubmit="return(validate());">
        ...
        if (isset($_GET['id'])) {
            ...
            $result = mysqli_query($mysqli, "SELECT MAX(no_rm) AS max_rm FROM pasien WHERE no_rm LIKE '$date%'");
            $data = mysqli_fetch_array($result);
            $max_rm = $data['max_rm'];
            $no_urut = $max_rm ? (int)substr($max_rm, 8) + 1 : 1; // Ambil angka urut terakhir
            $no_rm = $date . str_pad($no_urut, 4, '0', STR_PAD_LEFT); // Format no_rm
        }
        ...
        <div class="row">
            ...
            <div>
                <input type="text" class="form-control" name="no_rm" id="inputNoRM" value="<?php echo $no_rm ?>" readonly>
            </div>
        </div>
        <div class="row mt-3">
            <div class=col>
