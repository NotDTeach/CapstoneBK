                            ...
                            <tbody>
                                ...
                                if ($result_jadwal->num_rows > 0) {
                                    ...
                                    while ($row_jadwal = $result_jadwal->fetch_assoc()) {
                                        ...
                                        if ($row_jadwal['status'] == 'aktif') {
                                            echo '<button type="submit" name="nonaktifkan" class="btn btn-success btn-sm">Aktif</button>';
                                        } else {
                                            echo '<button type="submit" name="aktifkan" class="btn btn-secondary btn-sm">Nonaktif</button>';
                                        }
                                        echo '</form>';
                                        echo '</td>';
                                        echo '<td>';
                                        echo '<form method="post" action="hapus_jadwal.php" class="d-inline">';
                                        echo '<input type="hidden" name="id" value="' . $row_jadwal['id'] . '">';
                                    ...
                                    echo '<tr><td colspan="6">Tidak ada jadwal periksa yang tersedia</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
